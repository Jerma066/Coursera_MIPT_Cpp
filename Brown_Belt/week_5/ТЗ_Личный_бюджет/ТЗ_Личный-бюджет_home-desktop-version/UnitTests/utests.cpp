...
void TestBudgetManagerDecode() {
	...
	{
		BudgetManager bm;
		std::string oper = "PayTax 2000-01-02 2000-01-03";
		Instruction res = bm.Decode(oper);
		Instruction cor_ans = {Operation::PAY_TAX, Date("2000-01-02"), Date("2000-01-03"), -1};
...
void TestBudgetManagerEarn() {
	{
		...
		std::map<Date, double> res = bm.getFinance();
		std::map<Date, double> cor_ans = {
			{Date("2000-01-01"), 10}, 
			{Date("2000-01-02"), 10}
		};
	...
	
	{
		...
		std::map<Date, double> res = bm.getFinance();
		std::map<Date, double> cor_ans = {
			{Date("2000-01-01"), 5}, {Date("2000-01-02"), 5}, 
			{Date("2000-01-03"), 5}, {Date("2000-01-04"), 5}, 
			{Date("2000-01-05"), 5}, {Date("2000-01-06"), 5}
		};
		ASSERT_EQUAL(res, cor_ans);
	}

	{
		...
		std::map<Date, double> res = bm.getFinance();
		std::map<Date, double> cor_ans = {
			{Date("2000-12-29"), 5}, {Date("2000-12-30"), 5}, 
			{Date("2000-12-31"), 5}, {Date("2001-01-01"), 5}, 
			{Date("2001-01-02"), 5}, {Date("2001-01-03"), 5}
		};
		ASSERT_EQUAL(res, cor_ans);
	}
} 
...
void TestBudgetManagerPayTax() {
	{
		BudgetManager bm;
		bm.EarnMoney(Date("2000-01-01"), Date("2000-01-02"), 20);
		bm.PayTaxes(Date("2000-01-01"), Date("2000-01-02"));
		std::map<Date, double> res = bm.getFinance();
		std::map<Date, double> cor_ans = {
			{Date("2000-01-01"), 8.7}, 
			{Date("2000-01-02"), 8.7}
...

	{
		...
		bm.PayTaxes(Date("2000-01-02"), Date("2000-01-05"));
		std::map<Date, double> res = bm.getFinance();
		std::map<Date, double> cor_ans = {
			{Date("2000-01-01"), 10},  {Date("2000-01-02"), 8.7}, 
			{Date("2000-01-03"), 8.7}, {Date("2000-01-04"), 8.7}, 
			{Date("2000-01-05"), 8.7}, {Date("2000-01-06"), 10}
		};
		ASSERT_EQUAL(res, cor_ans);
	}
	
	{
		...
		bm.PayTaxes(Date("2000-12-26"), Date("2001-01-05"));
		std::map<Date, double> res = bm.getFinance();
		std::map<Date, double> cor_ans = {
			{Date("2000-12-29"), 8.7}, {Date("2000-12-30"), 8.7}, 
			{Date("2000-12-31"), 8.7}, {Date("2001-01-01"), 8.7}, 
			{Date("2001-01-02"), 8.7}, {Date("2001-01-03"), 8.7}
		};
		ASSERT_EQUAL(res, cor_ans);
	}
} 
